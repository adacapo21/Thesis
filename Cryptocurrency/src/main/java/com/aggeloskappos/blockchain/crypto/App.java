package com.aggeloskappos.blockchain.crypto;


import java.security.Security;

import com.aggeloskappos.blockchain.crypto.blockchain.Block;
import com.aggeloskappos.blockchain.crypto.blockchain.BlockChain;
import com.aggeloskappos.blockchain.crypto.constants.Constants;
import com.aggeloskappos.blockchain.cryptocurrency.Miner;
import com.aggeloskappos.blockchain.cryptocurrency.Transaction;
import com.aggeloskappos.blockchain.cryptocurrency.TransactionOutput;
import com.aggeloskappos.blockchain.cryptocurrency.Wallet;

public class App 
{
    public static void main(String[] args )
    {
        System.out.println( "****** Cryptocuurency World! ******" );
